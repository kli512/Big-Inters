...
class KDATable(QDialog):
    def __init__(self, parent, kda_data):
        self.logger = logging.getLogger('app.KDATable')
        self.logger.info('Initializing pop-up')
        super(KDATable, self).__init__(parent)
        self.setGeometry(300, 300, 600, 1000)
        self.kda_data = kda_data
        self.initUI()
        self.logger.info('Done initializing pop-up')
...
class Application(QWidget):
    def __init__(self):
        self.logger = logging.getLogger('app.Application')
    ...
    def run_analysis(self):
        self.logger.info('Starting player analysis')
